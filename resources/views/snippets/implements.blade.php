<!-- HTML generated using hilite.me --><div style="background: #202020; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><pre style="margin: 0; line-height: 125%"><span style="color: #cd2828; font-weight: bold">&lt;?php</span>
    ...
    <span style="color: #6ab825; font-weight: bold">class</span> <span style="color: #447fcf; text-decoration: underline">Dragon</span> <span style="color: #6ab825; font-weight: bold">implements</span> <span style="color: #d0d0d0">MonsterAnatomyInterface</span> <span style="color: #d0d0d0">{</span>
