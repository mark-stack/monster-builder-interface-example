<!-- HTML generated using hilite.me --><div style="background: #202020; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><pre style="margin: 0; line-height: 125%"><span style="color: #cd2828; font-weight: bold">&lt;?php</span>
    ...
    <span style="color: #6ab825; font-weight: bold">namespace</span> <span style="color: #d0d0d0">App\Interfaces;</span>

    <span style="color: #6ab825; font-weight: bold">interface</span> <span style="color: #d0d0d0">MonsterAttributesInterface</span> <span style="color: #d0d0d0">{</span>
